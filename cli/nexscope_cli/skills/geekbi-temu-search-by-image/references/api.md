...
- `{}` or missing `imageUrl`: HTTP 400, `imageUrl is required` (imageUrl is required)
...
| `title` | string | Observed value: `Temu Image Search` (Temu image search for matching products) |
