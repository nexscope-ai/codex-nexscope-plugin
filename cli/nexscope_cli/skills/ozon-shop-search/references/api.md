...
| sourceTool | string | Source tool, e.g., `Seerfar-Ozon-Store Lookup` |
...
| Condition | Action |
|---|---|
| Parameter error | Check `msg`; common causes include missing `id` (`id is required`), missing `page` (`page is required`) |
  ...
  "data": [
    {
      ...
      "sourceType": "ozon",
      "sourceTool": "Seerfar-Ozon-Store Lookup"
    }
  ],
  "products": [ ... ]
}
