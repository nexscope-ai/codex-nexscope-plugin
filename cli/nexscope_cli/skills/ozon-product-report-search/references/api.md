...
| sourceTool | string | Source tool identifier (e.g., `Seerfar-Ozon-Bestseller Lookup`) |
  ...
  "data": [
    {
      ...
      "fulfillment": ["FBO"],
      "sourceType": "ozon",
      "sourceTool": "Seerfar-Ozon-Bestseller Lookup",
      "categoryInfo": {
        "cnTitlePath": "Beauty and Hygiene > Personal Hygiene > Toilet Paper",
