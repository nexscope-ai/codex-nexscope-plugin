...
| `title` | string | `Temu Data Query` (Temu data query) |
...
| `regionId` | integer | Region ID used for this request |
| `title` | string | `Temu Product Details` (Temu product detail) |
| `sourceType` | string | `temu` |
| `sourceTool` | string | `geekbi_temu` |
...
| `title` / `sourceType` / `sourceTool` / `type` | string | `Temu Site List` (Temu site list) / `temu` / `geekbi_temu` / `tableListWorkbenches` |
| `columns` | array | Render column definitions |
...
```json
{
  "sites": [{"siteId": 1, "regionId": 211, "name": "United States", "cnName": "United States", "lang": "en", "currency": "USD"}],
  "total": 1,
  "title": "Temu Site List",
  "sourceType": "temu",
  "sourceTool": "geekbi_temu",
  "type": "tableListWorkbenches",
  "columns": []
...
| `title` / `sourceType` / `sourceTool` / `type` | string | `Temu Category List` (Temu category list) / `temu` / `geekbi_temu` / `tableListWorkbenches` |
| `columns` | array | Render column definitions |
